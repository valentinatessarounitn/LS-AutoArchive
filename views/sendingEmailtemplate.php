...
require_once __DIR__ . '/../../../application/helpers/admin/htmleditor_helper.php';
require_once __DIR__ . '/../../../application/helpers/common_helper.php';
            ...
            array(
                ...
                'aActions' => array(
                    ...
                    array(
                        ...
                        'action' => 'invite',
                        'disabled' => false,
                        'url' => App()->createUrl('plugins/direct&plugin=AutoArchive&function=sendBulkSurveyOwnerEmails'),
