...
class AAPluginInstaller
{
    ...
    public function installTables()
    {
        ...
        try {
            ...
            // aggiunta colonna tablella con riferimento all'ultimo invio di notifica
            // Create the table
            $oDB->createCommand()->createTable(self::$table, array(
                ...
                // Procedure: Creation (data never change) -> Opening (activation) -> Expiration -> Deactivation -> Deletion
