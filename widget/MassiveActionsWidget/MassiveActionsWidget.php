...
class massiveActionsWidget extends CWidget
{
    ...
    public function run()
    {
        ...
        $relativePath = '/plugins/AutoArchive/widget/MassiveActionsWidget/assets/listActions.js';
        $scriptUrl = $baseUrl . $relativePath;
     ...
     * in plugins/AutoArchive/grid/MassiveActionsWidget/views/modals
     * @return bool
     */
